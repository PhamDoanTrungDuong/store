    ...
    public partial class Initialize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAttributes", x => new { x.ColourId, x.ProductId, x.SizeId });
                    table.ForeignKey(
                        name: "FK_ProductAttributes_Colours_ColourId",
                        column: x => x.ColourId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductAttributes_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "dd658b9f-95d5-462c-b944-00deecd0e311", "Member", "MEMBER" },
                    { 2, "bfbfc06d-8d2a-4b26-b262-90fa0387f31d", "Admin", "ADMIN" }
                });
