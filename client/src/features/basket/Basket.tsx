				...
				<div className="md:basis-[30%]">
					...
					<div className="mt-5">
						...
						{/* <Link to="/checkout" className="w-full"> */}
							<button disabled className="bg-indigo-600 border border-indigo-600 text-white p-2 w-full rounded-lg shadow-lg my-2 hover:scale-105 hover:shadow-xl duration-200 flex justify-center items-center gap-2">
								<GrStripe size={20} />{" "}
