      ...
      <Grid item xs={2}>
        ...
        <div className="mb-4">
          <div className="flex text-darkred">
            ...
            <h4 className="ml-[3px] font-medium">Sort Order</h4>
          </div>
          <RadioButtonGroup
        ...
        <div className="mb-4">
          <div className="flex text-darkred">
            ...
            <h4 className="ml-[3px] font-medium">Brands</h4>
          </div>
          <CheckboxButton
            options={brands}
            checked={productParams.brands}
            onChange={(options: string[]) =>
              dispatch(setProductParams({ brands: options }))
            }
          />
        </div>
        ...
        <div>
          <div className="flex text-darkred">
            ...
            <h4 className="ml-[3px] font-medium">Types</h4>
          </div>
          <CheckboxButton
            options={types}
            checked={productParams.types}
            onChange={(options: string[]) =>
              dispatch(setProductParams({ types: options }))
            }
          />
        </div>
      </Grid>
