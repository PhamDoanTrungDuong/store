...
const resources = {
  en: {
    translation: {
      ...
      //Profile
      "Pro_YourProfile": "Your Profile",
      "Pro_Phone": "Phone Number",
      "Pro_Fullname": "Full Name",
      "Pro_Addr1": "Address 1",
      "Pro_Addr2": "Address 2",
      "Pro_City": "City",
      "Pro_State": "State",
      ...
      "Ca_Subtotal": "Subtotal",
      "Ca_Sumary": "Sumary",
      "Ca_DeFe": "Delivery fee*",
      "Ca_Total": "Total",
      "Ca_PolicyFee": "*Orders over $100 qualify for free delivery",
      "Ca_Dis": "Discount for basket",
      "Ca_Voucher": "Vouchers",
      "Ca_Methods": "Please choose your payment methods!!!",
      "Ca_Checkout": "Checkout",
      "Ca_Cancel": "Cancel",
      "Ca_Apply": "Apply",
      
      //Checkout
      "Check_Checkout": "Checkout",
      "Check_ShippingAddr": "Shipping Address",
      "Check_Review": "Review Your Order",
      "Check_PaymentDetail": "Payment Details",
      "Check_ChooseAddr": "Choose Another Address",
      "Check_NewShipAddre": "New Shipping Address",
      "Check_Fullname": "Full Name",
      "Check_Phone": "Phone Number",
      "Check_Addr1": "Address 1",
      "Check_Addr2": "Address 2",
      "Check_City": "City",
      "Check_State": "State",
      "Check_Country": "Country",
      "Check_Save": "Save this as the default address",
      "Check_Next": "NEXT",
      "Check_Back": "BACK",
      "Check_PlaceOrder": "PLACE ORDER",
      "Check_Thank": "Thank you - We have received your payment",
      "Check_YourOrder": "Your order number is",
      "Check_Noti": "We have not emailed your order confirmation, and will not send you an update when your order has shipped as this is a fake store",
      "Check_BackCat": "Back to Catalog",
      "Check_GoOrder": "Go to your Order",
      "Check_PayMethod": "Payment Method",
      
      //Order
      "Ord_Pending": "PENDING ORDERS",
      "Ord_Comfirmed": "COMFIRMED",
      ...
      "Ord_City": "City",
      "Ord_Total": "Total",
      "Ord_OrdDate": "Order Date",
      "Ord_Status": "Delivery Status",
      "Ord_PendingStatus": "Pending",
  ...
  vi: {
    translation: {
      ...
      //Profile
      "Pro_YourProfile": "Thông Tin Cá Nhân",
      "Pro_Phone": "Số Điện Thoại",
      "Pro_Fullname": "Họ và Tên",
      "Pro_Addr1": "Địa Chỉ 1",
      "Pro_Addr2": "Địa Chỉ 2",
      "Pro_City": "Thành Phố",
      "Pro_State": "Tiểu Bang",
      ...
      "Ca_Var": "Kiểu",
      "Ca_Price": "Giá",
      "Ca_Quantity": "Số Lượng",
      "Ca_Subtotal": "Tổng phụ",
      "Ca_Sumary": "Tóm Tắt",
      "Ca_DeFe": "Phí Vận Chuyển",
      "Ca_Total": "Tổng",
      "Ca_PolicyFee": "*Đơn đặt hàng trên 100 đô la đủ điều kiện để được giao hàng miễn phí",
      "Ca_Dis": "Giảm giá cho giỏ",
      "Ca_Voucher": "Phiếu giảm giá",
      "Ca_Methods": "Vui lòng chọn phương thức thanh toán của bạn!!!",
      "Ca_Checkout": "Thanh Toán",
      "Ca_Cancel": "Hủy",
      "Ca_Apply": "Nhận",

      //Checkout
      "Check_Checkout": "Thanh Toán",
      "Check_ShippingAddr": "Địa Chỉ Giao Hàng",
      "Check_Review": "Xem Đơn hàng",
      "Check_PaymentDetail": "Chi Tiết Thanh Toán",
      "Check_ChooseAddr": "Chọn Địa Chỉ Khác",
      "Check_NewShipAddre": "Địa Chỉ Giao Hàng Mới",
      "Check_Fullname": "Họ và Tên",
      "Check_Phone": "Số Điện Thoại",
      "Check_Addr1": "Địa Chỉ 1",
      "Check_Addr2": "Địa Chỉ 2",
      "Check_City": "Thành Phố",
      "Check_State": "Tiểu Bang",
      "Check_Country": "Vùng",
      "Check_Save": "Lưu địa chỉ này làm địa chỉ mặc định",
      "Check_Next": "TIẾP",
      "Check_Back": "VỀ",
      "Check_PlaceOrder": "ĐẶT",
      "Check_Thank": "Cảm ơn bạn - Chúng tôi đã nhận được khoản thanh toán của bạn",
      "Check_YourOrder": "Mã đơn đặt hàng của bạn là",
      "Check_Noti": "Chúng tôi chưa gửi email xác nhận đơn đặt hàng của bạn và sẽ không gửi cho bạn thông tin cập nhật khi đơn hàng của bạn được giao vì đây là một cửa hàng giả mạo",
      "Check_BackCat": "Trở về Catalog",
      "Check_GoOrder": "Đi đến lịch sử",
      "Check_PayMethod": "Phương Thức Thanh Toán",

      //Order
      "Ord_Pending": "ĐƠN HÀNG CHỜ",
      "Ord_Comfirmed": "ĐÃ XÁC NHẬN",
      "Ord_Delivered": "ĐÃ GIAO",
      "Ord_Refunded": "ĐÃ HOÀN TRẢ",
      "Ord_OrdNum": "Mã Đơn",
      "Ord_Addr": "Địa Chỉ",
      "Ord_City": "Thành Phố",
      "Ord_Total": "Tổng",
      "Ord_OrdDate": "Ngày Đặt",
      "Ord_Status": "Trạng Thái",
      "Ord_PendingStatus": "Chờ",
